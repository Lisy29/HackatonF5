  ...
  return (
    <div>
      <div class="flex justify-between items-center">
        <img src="../src/assets/logo.png" alt="ecoCityHub" class="w-[60px] h-[60px] m-4"/>
        <svg className="mr-8" width="19" height="22" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Notification">
        <g id="Group 3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
        <img src="../src/assets/img-home/img.png" alt="" class="w-full h-full"/>
        <div class="bg-white shadow-md rounded-lg p-4 ml-4 mr-4">
          <h2 class="text-xl font-bold mb-2">Reporte de Tráfico AEMT</h2>
